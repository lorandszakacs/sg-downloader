...
object Favorites {
  ...
  private lazy val _modelsNames =
    List(
      ...
      "hylia", "idony", "illusion", "indi", "jackye", "jam", "jamity", "janedoe", "janesinner", "janette",
      "jessicalou", "joker", "july", "kacy", "kala", "kaotika", "karanlit", "katherine", "kaylindear", "kemper",
      "kirbee", "kush", "ladyviolet", "lait", "lalka", "lanei", "lass", "lavonne", "lego", "lillianrose",
      "lilymai", "lilyt", "liu", "livay", "liya", "luana", "lucerne", "lucid", "lumo", "lunar",
      "luxlee", "lylie", "lyvia", "lyxzen", "machete", "magpie", "mah", "manko", "maokiz", "marajade",
      "margarette", "marialauriejupiter", "marlene", "marquise", "mars", "maud", "mel", "melbee", "mendacia", "mermaid",
      "milenci", "mille", "milloux", "mistica", "mnemozyne", "moon", "morrigan", "natashalegeyda", "nattybohh", "nemesis",
      "ness", "nubia", "okami", "ondinae", "oogie", "paloma", "pandie", "pandub", "patton", "pesky",
      ...
      "raleigh", "rambo", "rawruh", "reed", "revenge", "rhue", "riae", "ripley", "riversong", "rjen",
      "rourke", "sabbbre", "saint", "salliss", "saralilith", "saria", "sashabrink", "satelina", "satin", "saturn",
      ...
      "stephy", "sterling_", "stormyent", "sugarkane90", "sunny", "tabbytha", "talena", "tangerine", "tanyabat", "tarion",
      ...
      "viking", "vivid", "waikiki", "whiskey", "wilhelmine", "wolf", "yesenia", "yugen", "yusuracircus", "yuxi",
      "zad", "zell", "zenit", "zephi", "zilvia", "zippo", "zoli"
    ).sorted.distinct

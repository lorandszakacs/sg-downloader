...
object Favorites {
  ...
  private lazy val _modelsNames =
    List(
      ...
      "marquise", "mars", "maud", "mel", "melbee", "mendacia", "mermaid", "miele", "milenci", "mille",
      "milloux", "missfernandez", "mistica", "mistyy", "mnemozyne", "moon", "morrigan", "narciss", "natashalegeyda", "nattybohh",
      "nebula", "nemesis", "nery", "ness", "noel", "nubia", "okami", "ondinae", "oogie", "paloma",
      "pandie", "pandub", "patton", "paulam", "pesky", "phoenix", "pia", "piedpiper", "pilot", "pirate",
      ...
      "scribbles", "sedona", "shamandalie", "shannon_", "shaunanyx", "shine", "shotgun", "sibila", "silencia", "silvi",
      "sinnah", "sinni", "skinbyrd", "skydot", "skyhook", "slim", "smash", "spliff", "spock", "stephy",
      "sterling_", "stormyent", "sua", "sugarkane90", "sunny", "tabbytha", "talena", "tangerine", "tanyabat", "tarion",

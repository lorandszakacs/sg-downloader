...
JVM_ARGS='-Xmx4G -Xms2G -XX:+UseConcMarkSweepGC -XX:+CMSClassUnloadingEnabled -Xss64M -XX:+UseStringDeduplication -XX:+PrintStringDeduplicationStatistics'
...
#we copy from the delta folder, to the destination folder
SRC_FOLDER=$ROOT/delta/models/
...
java -jar $JVM_ARGS $JAR_NAME delta;

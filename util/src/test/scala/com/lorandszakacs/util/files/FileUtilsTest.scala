...
class FileUtilsTest extends FlatSpec {
  ...
  it should "... match files where everything is the same but the date" in {
    val s1 = "/home/models/favorites/porcelinna/porcelinna_2016-06-11_PEACH_BLOSSOM.html"
    val s2 = "/home/models/favorites/porcelinna/porcelinna_2016-07-19_PEACH_BLOSSOM.html"
  ...
  it should "... not match files where anything other than the date is not equal" in {
    val s1 = "/home/models/favorites/porcelinna/porcelinna_2016-06-11_PEACH_BLOSSOM.html"
    val s2 = "/home/models/favorites/porcelinna/porcelinna_2014-12-29_ART_SCHOOL_CONFIDENTIAL.html"
